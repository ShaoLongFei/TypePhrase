<template>
  <div>
    ...
    <section>
      <h2>1. 信息的收集</h2>
      <p>TypePhrase 当前不提供账户注册和登录功能，也不会主动收集账户身份信息。</p>
      <p>使用课程包学习时，学习过程默认在当前浏览器中进行，不要求提供姓名、电话或邮箱。</p>
    </section>

    <section>
      <h2>2. 信息的使用</h2>
      <p>我们仅使用必要的技术信息来保障服务正常运行、排查问题和改进学习体验。</p>
      <p>我们不会将个人信息出售给第三方。</p>
    </section>
    ...
    <section>
      ...
      <p>
        ...
        Cookie，产品能够存储您的偏好等数据，提升服务质量及优化用户体验。
      </p>
      <p>
